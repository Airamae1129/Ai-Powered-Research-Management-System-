    ...
    <div class="row justify-content-center">
        <div class="col-md-9 mt-4"> <!-- Added mt-4 for margin-top -->
            ...
            <div class="unselectable">
                ...
                include('system/dist/dbcon.php');
                $id=$_GET['id'];
                $query=mysqli_query($con,"select * from  research where id='$id'")or die(mysqli_error());
                while($row=mysqli_fetch_array($query)){  
                ?>
                <!-- Main content area -->
                <div class="research-item">
                    <h2><a href="read5.php?file=<?php echo $row['file']?>"  style="color: #0e1e83;"><?php echo $row['title']?></a></h2>
                    <p><strong>Abstract:</strong> 
                        <?php
                        echo mb_strimwidth($row['abstract'], 0, 10000, "...");
                        //Hello W...
                        ?>
                    </p>
    ...
    <div class="fixed-bottom mr-md-3 mb-md-3" id="floatingButton">
        <div class="row justify-content-md-end">
            <div class="col-md-9 text-right">
                <a href="service.php" class="btn btn-dark" id="backToTopButton">Back to Researchers</a>
            </div>
        </div>
    </div>
</div>
