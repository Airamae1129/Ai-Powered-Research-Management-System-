...
?>
        ...
        <div class="container">    <form method="POST"  action="read4.php"> 
            <div class="row">
              <div class="col-md-3">
                <div class="sidebar">
                  ...
                  <div class="form-group">
                    <label for="yearTo">Year To:</label>
                           <select name="year2" type="text" id="yearFrom" class="form-control">
...
<div class="form-group">
    ...
    <select name="program" type="text" id="yearFrom" class="form-control">
    <option>select option-</option>
        <?php
        include('system/dist/dbcon.php');
        $query = mysqli_query($con, "select * from city ") or die(mysqli_error());
        ...
        ?>
                  ...
                  <button class="btn btn-light">  Clear  </button>      <button type="submit" class="btn btn-primary">Apply Filters</button>
                </div>
              </div>
              <div class="col-md-9">
...
$query=mysqli_query($con,"select * from  research where year1>='$id' and year1<='$id2' and course='$program'")or die(mysqli_error());
while($row=mysqli_fetch_array($query)){  
