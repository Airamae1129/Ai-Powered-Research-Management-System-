...
?>
                ...
                <div class="container">
    <form method="POST" action="read6.php"> 
        <div class="row">
            <div class="col-md-3">
                <div class="sidebar">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="year1" name="year1" class="form-control">
                    </div>

                    <div class="form-group">
                        <label>Program:</label><br>
                        <select name="course" type="text" id="yearFrom" class="form-control">
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                            ?>
                            <option href="read2.php?course=<?php echo $row['name']; ?>"><?php echo $row['name']; ?></option>
                            <?php
                            }
                            ?>
                        </select> 
            ...
            <div class="col-md-9">
                ...
                <div class="unselectable">
                    ...
                    // Initialize variables to store filter options
                    $year1 = $_POST['year1'];
                    $course= $_POST['course'];
                    $author = $_POST['author'];
                    $keyword = $_POST['keyword'];

                    // Check if any filter options are submitted
                    if (!empty($year1) || !empty($program) || !empty($author) || !empty($keyword)) {
                        // Construct the SQL query based on the selected filter options
                        $sql = "SELECT * FROM research WHERE 1";

                        // Add conditions based on filter options
                        if (!empty($year1)) {
                            $sql .= " AND year1 LIKE '%$year1%'";
                        }

                        if (!empty($program) && $program != 'select option-') {
                            $sql .= " AND course = '$program'";
                        }
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            // Loop through each row and display research items
                            while ($row = mysqli_fetch_assoc($result)) {
                    ?>
                                <!-- Main content area -->
                                <div class="research-item">
                                    <h2><a href="#" style="color: #0e1e83;"><?php echo $row['title']?></a></h2>
                    ...
                    <?php
                        ...
                        // If no filter options are submitted, display nothing or redirect to main page
                        // Example: header("Location: main_page.php");
                        echo "<p>No filter options selected.</p>";
                    }
                    ?>
                </div>
                ...
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                        <a href="index.html" class="navbar-brand">
                            <h4 class="m-0"><img src="./img/logo.png" style="width: 80px; height: auto;">Eastwoods Research Hub</h4>
                        </a>
